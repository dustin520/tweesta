...
(function() {
  var SessionControllers, SessionsCtrl;

  SessionControllers = angular.module("SessionControllers", []);

  SessionsCtrl = (function() {
    function SessionsCtrl(scope, http, location, rootScope) {
      this.scope = scope;
      this.http = http;
      this.location = location;
      this.rootScope = rootScope;
      this.greeting = "hello session!";
    }

    SessionsCtrl.prototype.loginUser = function(logUser) {
...
(function() {
  ...
  main = angular.module("TweestaApp", ["TweestaRouter", "TweestaControllers", "TweestaFactories", "UserRouter", "UserControllers", "SessionRouter", "SessionControllers"]);

  main.controller("MainCtrl", [
    "$scope", "$http", "$rootScope", function($scope, $http, $rootScope) {
      if (!$scope.current_user) {
        console.log("Checking for current user");
        $http.get("/logged_in_user.json").success((function(_this) {
      ...
      return $rootScope.sign_out = (function(_this) {
        return function() {
          return $http["delete"]("/logout.json").success(function(data) {
            $set_user(null);
...
(function() {
  ...
  Router = (function() {
    function Router(routeProvider, locationProvider) {
      ...
      this.routeProvider.when("/about", {
        templateUrl: "/about_templates",
        controller: "AboutsCtrl as abouts"
      });
      this.routeProvider.when("/contact", {
...
(function() {
  ...
  TweestasCtrl = (function() {
    function TweestasCtrl(scope, Tweesta, http, routeParams) {
      this.scope = scope;
    ...
    TweestasCtrl.prototype.tryMe = function() {
      this.scope.tryNow = true;
      return this.scope.showSearch = true;
    };

    TweestasCtrl.prototype.searchTag = function(newTag) {
      console.log(newTag);
      return this.Tweesta.lookUp(newTag).success((function(_this) {
        return function(data) {
          _this.tagArray.push(newTag);
          _this.scope.renderContent = true;
          _this.results = data;
          return _this.saved.push(_this.results);
        };
      })(this));
    };

    TweestasCtrl.prototype.loadMore = function(newTag) {
      return this.Tweesta.lookUp(newTag).success((function(_this) {
        return function(data) {
          console.log("LOAD MORE: " + newTag);
          _this.results = data;
          _this.saved.push(_this.results);
          console.log("saved:" + _this.saved);
          return console.log(_this.saved);
        };
      })(this));
    };

    TweestasCtrl.prototype.saveTag = function(newTag) {
      console.log("routeParams", this.routeParams.id);
      return this.http.get("/users/" + this.routeParams.id + ".json").success((function(_this) {
        return function(data) {
    ...
    TweestasCtrl.prototype.deleteTag = function() {
      console.log(this.saved);
      this.saved = [];
      return this.scope.renderContent = false;
    };
...
(function() {
  ...
  UsersCtrl = (function() {
    ...
    UsersCtrl.prototype.createUser = function(newUser) {
      console.log(newUser);
